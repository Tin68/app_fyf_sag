...
#from app_fyf_sag.componentes.auth_sesion import AuthSession
from app_fyf_sag.componentes.user import User
from app_fyf_sag.componentes.auth_sesion import AuthSession

AUTH_TOKEN_LOCAL_STORAGE_KEY = "_auth_tokens"
DEFAULT_AUTH_SESSION_EXPIRATION_DELTA = datetime.timedelta(minutes=30)
